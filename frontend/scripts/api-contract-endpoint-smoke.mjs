...
export function runApiEndpointContracts({ client, endpoints, searchBuilders }) {
  ...
  const expectedEndpoints = [
    ...
    { method: 'PATCH', path: '/api/admin/auth/profile', typeArgument: 'AdminMe' },
  ...
  assertContains(endpoints.text, "search.set('ticketTypeId', String(params.ticketTypeId))", 'optional time slot ticket type query')
