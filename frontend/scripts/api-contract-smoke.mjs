...
assertContains(adminWorkbench.text, 'id="admin-reports"', 'admin workbench exposes report anchor')
assertContains(adminWorkbench.text, 'id="admin-tickets"', 'admin workbench exposes tickets anchor')
assertContains(adminWorkbench.text, 'id="admin-orders"', 'admin workbench exposes order anchor')
assertContains(adminWorkbench.text, 'id="admin-audit"', 'admin workbench exposes audit anchor')
...
assertContains(adminReportCss.text, '.admin-report-insight-grid', 'admin report css must own report insight grid layout')
assertContains(adminReportsPanel.text, 'admin-report-insight-grid', 'admin reports panel must group summary and reconciliation as an insight grid')
assertContains(adminReportsPanel.text, 'admin-report-summary-stack', 'admin reports panel must keep summary metrics grouped')
...
assertContains(adminReportsPanel.text, '报表接口只读取运营数据', 'admin reports panel read-only boundary')
