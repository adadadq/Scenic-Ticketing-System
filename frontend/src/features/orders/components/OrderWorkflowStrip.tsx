...
export function OrderWorkflowStrip({
  ...
  return (
    <section className="orders-workflow-strip" aria-label="订单流程" data-active-status={statusFilter}>
      <Flex className="orders-workflow-heading" align="center" justify="space-between" gap={8} wrap>
        <div>
          <Text className="orders-workflow-title">订单流程</Text>
